package week12.slot02.controller;
...
import week12.slot02.ProductApplication;
import week12.slot02.repository.ConnectDatabase;
...
public class LoginController {
	...
	@FXML public void login() throws IOException {
		...
		if(ConnectDatabase.login(username, password)) {
